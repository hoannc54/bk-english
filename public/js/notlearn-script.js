var notlearn = {
    ...
    length1page: 2,
//    Các biến thông báo
    emty: '<div style="text-align: center;">Danh sách trống.</div>',
    loading: '<div style="text-align: center;"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i></div>',
    ...
    show_pagination: function (curentPage) {
//        curentPage = 10;
...
//            html += '<div class="col-12">';
            ...
            if (this.data[i]['examples']) {
                html += '<div class="example">' + this.data[i]['examples'][0]['example'] + '</div><div class="mean_example">' + this.data[i]['examples'][0]['mean'] + '</div>';
            }
            html += '</div>';
            html += '</div>';
            html += '</div>';
