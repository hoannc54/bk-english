...
<!--                <li>
                    <a href="#"><i class="fa fa-file-word-o fa-fw"></i> Multi-Level Dropdown<span class="fa arrow"></span></a>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">Thêm câu mới</a>
                        </li>
                        <li>
                            <a href="#">Danh sách câu ví dụ</a>
                        </li>
                    </ul>
                </li>
                
                <li>
                    <a href="#"><i class="fa fa-group fa-fw"></i> Quản lý người dùng<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
